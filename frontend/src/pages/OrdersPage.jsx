import { ChevronRightIcon, PackageIcon, TruckIcon } from "lucide-react";
                  ...
                  <div className="card-body flex-row flex-wrap items-center gap-4 py-5 sm:gap-5">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {o.shipmentStatus && o.shipmentStatus !== "pending" && (
                          <span className={`badge badge-sm gap-1 ${
                            o.shipmentStatus === "delivered"        ? "badge-success"
                            : o.shipmentStatus === "shipped" || o.shipmentStatus === "out_for_delivery" ? "badge-primary"
                            : o.shipmentStatus === "cancelled" || o.shipmentStatus === "returned"      ? "badge-error"
                            : "badge-ghost"
                          }`}>
