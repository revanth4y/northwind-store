  ...
  return (
    <div className="mx-auto max-w-lg text-center">
      ...
      <p className="mt-4 text-base-content/70">
        Your order is created once payment is confirmed — it will appear as{" "}
        <strong className="text-base-content">paid</strong> in your orders list. Need help? Start a{" "}
        <strong className="text-base-content">Video Meeting</strong> with our support team directly
        from the order page.
      </p>
