...
import { imageKitOptimizedUrl } from "../lib/imagekitUrl.js";
    ...
    <form className="mt-4 flex flex-col gap-3" onSubmit={handleSubmit}>
      ...
      <div className="form-control w-full">
        ...
        <label className="mb-2 flex cursor-pointer flex-wrap items-center gap-2">
          ...
          <span className="text-xs text-base-content/60">PNG, JPG, WebP, GIF · max 10 MB</span>
        ...
        {imageUrl ? (
          <div className="mt-2 overflow-hidden rounded-lg border border-base-300 bg-base-200 p-2">
            <img
              src={imageKitOptimizedUrl(imageUrl)}
              alt=""
