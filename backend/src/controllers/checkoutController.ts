...
export async function createCheckout(req: Request, res: Response, next: NextFunction) {
  console.log("[checkout] POST /api/checkout received");
  try {
    // only signed-in users can start checkout
    const { userId, isAuthenticated } = getAuth(req);
    console.log("[checkout] auth:", { userId, isAuthenticated });
    ...
    console.log("[checkout] calling Polar API...");
    ...
    console.log("[checkout] ✅ checkout created:", checkout.url);
